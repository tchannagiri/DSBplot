...
def make_precomputed_layout(
  ...
  ### Write to files ###
  file_out = file_names.sequence_data(output, subst_type)
  log_utils.log_output(file_out)
  file_utils.write_tsv(seq_data, file_out)
  file_out = file_names.edge_data(output, subst_type)
  file_utils.write_tsv(edge_data, file_out)
  log_utils.log_output(file_out)
  log_utils.new_line()

if __name__ == '__main__':
  make_precomputed_layout(**parse_args()) 