...
DSBplot-preprocess --ref_seq_file $ref_seq_dir/2DSB_Sense_R1.fa --dsb_pos 67 --output $output_dir/Sense_R1 --stages 1_filter --total_reads 3000 3000 3000 3000
...
### Plot the graphs (PNG) ###
DSBplot-graph --input $output_dir/Sense_R1 --output plots/graph/Sense_R1_universal.png --layout universal --title "Sense (R1) Universal Layout" --width 2400 --height 1800 --universal_y_axis_x_pos 0 --universal_x_axis_deletion_y_pos 0 --universal_x_axis_insertion_y_pos 0
DSBplot-graph --input $output_dir/Sense_R1 --output plots/graph/Sense_R1_kamada.png --layout kamada --title "Sense (R1) Kamada-Kawaii Layout" --width 2400 --height 1800 --separate_components
DSBplot-graph --input $output_dir/Sense_R1 --output plots/graph/Sense_R1_radial.png --layout radial --title "Sense (R1) Radial Layout" --width 2400 --height 1800
