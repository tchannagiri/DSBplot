...
DSBplot-histogram --input data/output/sense_R1 --output plots/histogram/png/sense_R1_substitution.png --title "Sense (R1)\nSubstitutions" --color "#bfbfbf" --variation_type substitution --label_type relative
DSBplot-histogram --input data/output/sense_R1 --output plots/histogram/png/sense_R1_insertion.png --title "Sense (R1)\nInsertions" --color "#ffa500" --variation_type insertion --label_type relative
DSBplot-histogram --input data/output/sense_R1 --output plots/histogram/png/sense_R1_deletion.png --title "Sense (R1)\nDeletions" --color "#8080ff" --variation_type deletion --label_type relative
