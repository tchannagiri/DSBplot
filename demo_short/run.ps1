...
DSBplot-preprocess --ref $ref_seq_dir/2DSB_Sense_R1.fa --dsb 67 -o $output_dir/Sense_R1 --reads 3000 3000 3000 3000 --stages 1
DSBplot-preprocess --ref $ref_seq_dir/2DSB_Sense_R1.fa --dsb 67 -o $output_dir/Sense_R1 --label Sense_R1 --reads 3000 3000 3000 3000 --stages 2
DSBplot-preprocess -o $output_dir/Sense_R1 --stages 3
DSBplot-preprocess -o $output_dir/Sense_R1 --ref $ref_seq_dir/2DSB_Sense_R1.fa --dsb 67 --stages 4
