...
# First way: Do all prcessing stages in a single command
...
# Second way: Run each processing stages separately
...
# The SAM files are actually just generated by Bowtie 2 in the same way as before so they
# give identical results. However, users are free to use their own alignment method.
